...
export const api = {
  ...
  deleteCaseGeolocation: (caseId, geolocationId) => apiClient.delete(`/api/v1/cases/${caseId}/geolocations/${geolocationId}`),
  geocodeCaseAddress: (caseId, data) => apiClient.post(`/api/v1/cases/${caseId}/geocode`, data),
